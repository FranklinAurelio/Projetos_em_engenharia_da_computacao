...
//Sul
  ...
  Dados(
      ...
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Bosque dos Eucaliptos",
      cep: "12233-640",
      localization: [-23.25053, -45.8957925],
      qtdOfDose: (totalDoses * 0.043),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Colonial",
      cep: "12234-730",
      localization: [-23.280593, -45.9042213],
      qtdOfDose: (totalDoses * 0.022),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Dom Pedro",
      cep: "12232-680",
      localization: [-23.277365, -45.8971845],
      qtdOfDose: (totalDoses * 0.027),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Oriente",
      cep: "12236-050",
      localization: [-23.2446905, -45.9039846],
      qtdOfDose: (totalDoses * 0.006),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS União",
      cep: "12239-012",
      localization: [-23.2658104, -45.9170189],
      qtdOfDose: (totalDoses * 0.013),
      distance: 0,
      espediente: "das 07h as 18h"),
];
