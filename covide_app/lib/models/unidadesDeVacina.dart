...
//Leste
  ...
  Dados(
      ...
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Novo Horizonte",
      cep: "12225-011",
      localization: [-23.1937738, -45.7937779],
      qtdOfDose: (totalDoses * 0.020),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Paraíso do Sol",
      cep: "12225-170",
      localization: [-23.1837733, -45.8056076],
      qtdOfDose: (totalDoses * 0.015),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Santa Inês II",
      cep: "12248-515",
      localization: [-23.167023, -45.8147778],
      qtdOfDose: (totalDoses * 0.006),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Vila Industrial",
      cep: "12220-270",
      localization: [-23.1792552, -45.8685915],
      qtdOfDose: (totalDoses * 0.007),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Vila Tesouro",
      cep: "12221-630",
      localization: [-23.1691562, -45.8512159],
      qtdOfDose: (totalDoses * 0.013),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Vista Verde",
      cep: "12223-600",
      localization: [-23.1764829, -45.8308332],
      qtdOfDose: (totalDoses * 0.015),
      distance: 0,
      espediente: "das 07h as 18h"),
//Norte
  ...
  Dados(
      ...
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS São Francisco Xavier",
      cep: "12210-070",
      localization: [-22.919194, -46.0682582],
      qtdOfDose: (totalDoses * 0.002),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Telespark",
      cep: "12212-700",
      localization: [-23.1597368, -45.9178548],
      qtdOfDose: (totalDoses * 0.025),
      distance: 0,
      espediente: "das 07h as 18h"),
  Dados(
      name: "UBS Vila Paiva",
      cep: "12239-061",
      localization: [-23.1374297, -45.9185615],
      qtdOfDose: (totalDoses * 0.006),
      distance: 0,
      espediente: "das 07h as 18h"),
//Oeste
